...
class XAgendaNotInit extends AbstractAgenda
{
    protected function __construct()
    {
        ...
        parent::__construct(new Common\NamespacesPaths(), new ValueTransformer\SanitizeEncoding(new ValueTransformer\Listing()));
    }
...
class AgendaFactoryTest extends CommonTestClass
{
    ...
    {
        $lib = new Pohoda\AgendaFactory(new Pohoda\Common\NamespacesPaths(), new ValueTransformer\SanitizeEncoding(new ValueTransformer\Listing()));
