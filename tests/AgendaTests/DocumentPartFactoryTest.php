...
class DocumentPartFactoryTest extends CommonTestClass
{
    ...
    {
        $lib = new Pohoda\DocumentPartFactory(new Pohoda\Common\NamespacesPaths(), 'some no');
...
class XDocPartNotInit extends Pohoda\Document\AbstractPart
{
    protected function __construct()
    {
        ...
        parent::__construct(new Pohoda\Common\NamespacesPaths(), [], 'num');
    }
...
{
    public function __construct(object $obj, array $data, string $number, bool $opts = false)
    {
    }
}
