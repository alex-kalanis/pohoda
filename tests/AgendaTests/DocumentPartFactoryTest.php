...
class DocumentPartFactoryTest extends CommonTestClass
{
    ...
    {
        $lib = new Pohoda\DocumentPartFactory(new Pohoda\Common\NamespacesPaths(), new ValueTransformer\SanitizeEncoding(new ValueTransformer\Listing()), Pohoda\Common\CompanyRegistrationNumber::init('some no'));
