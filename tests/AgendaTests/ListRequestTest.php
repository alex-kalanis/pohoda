...
class ListRequestTest extends CommonTestClass
{
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'Category'], '123');
...
//        $this->assertEquals(, $lib->getXML()->asXML());
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'ActionPrice'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'Order'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'Invoice', 'invoiceType' => 'issuedAdvanceInvoice'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'Vydejka'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'IssueSlip'], '123');
        $this->assertEquals('<lst:listVydejkaRequest version="2.0" vydejkaVersion="2.0"><lst:requestVydejka/></lst:listVydejkaRequest>', $lib->getXML()->asXML());
    }

    public function testProdejka(): void
    {
        $lib = new Pohoda\ListRequest(['type' => 'Prodejka'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'CashSlip'], '123');
        $this->assertEquals('<lst:listProdejkaRequest version="2.0" prodejkaVersion="2.0"><lst:requestProdejka/></lst:listProdejkaRequest>', $lib->getXML()->asXML());
    }

    public function testAddressBook(): void
    {
        $lib = new Pohoda\ListRequest(['type' => 'Addressbook'], '123');
...
//        $this->assertEquals(, $lib->getXML()->asXML());
    ...
    {
        $lib = new Pohoda\ListRequest(['type' => 'Stock'], '123');
