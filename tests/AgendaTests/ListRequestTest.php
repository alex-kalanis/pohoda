...
class ListRequestTest extends CommonTestClass
{
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Category'], '123');
...
//        $this->assertEquals(, $lib->getXML()->asXML());
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'ActionPrice'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Order'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Invoice', 'invoiceType' => 'issuedAdvanceInvoice'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Vydejka'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'IssueSlip'], '123');
        $this->assertEquals('<lst:listVydejkaRequest version="2.0" vydejkaVersion="2.0"><lst:requestVydejka/></lst:listVydejkaRequest>', $lib->getXML()->asXML());
    }

    public function testProdejka(): void
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Prodejka'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'CashSlip'], '123');
        $this->assertEquals('<lst:listProdejkaRequest version="2.0" prodejkaVersion="2.0"><lst:requestProdejka/></lst:listProdejkaRequest>', $lib->getXML()->asXML());
    }

    public function testAddressBook(): void
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Addressbook'], '123');
...
//        $this->assertEquals(, $lib->getXML()->asXML());
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'IntParam'], '123');
        $this->assertEquals('<lst:listIntParamRequest version="2.0"><lst:requestIntParam/></lst:listIntParamRequest>', $lib->getXML()->asXML());
    }

    public function testUserList(): void
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'UserList'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Invoice'], '123');
    ...
    {
        $lib = new Pohoda\ListRequest(new Pohoda\Common\NamespacesPaths(), ['type' => 'Stock'], '123');
